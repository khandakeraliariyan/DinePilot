...
public class RabbitTopologyConfig {
    ...
    @Bean Binding orderCreatedBinding(TopicExchange dinepilotExchange, Queue orderCreatedQueue) {
        return BindingBuilder.bind(orderCreatedQueue).to(dinepilotExchange).with("order.created");
    }
